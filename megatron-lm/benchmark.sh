...
JOB_ID=$(sbatch --nodes=$NUM_NODES  --output ${METRICS_DIR_PATH}/${LOG_FILE_NAME}_%j.out --error ${METRICS_DIR_PATH}/${LOG_FILE_NAME}_%j.err distributed_training.sbatch | awk '{print $4}')
